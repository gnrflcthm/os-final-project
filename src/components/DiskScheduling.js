    ...
    return (
        <div className="px-3">
            <div className="position-relative d-flex justify-content-start px-1">
                <p className="position-absolute m-0 p-0 return-btn" onClick={() => onReturn()}><i className="bi-caret-left-fill"></i><span className="return-btn-text">Return</span></p>
            ...
            <div className="position-relative row">
            {
                transition((style, item) => {
                    ...
                    switch(item) {
                        case "DSInput":
                            component = <DSInput updateDiskSchedData={(data) => setDiskSchedData(data)} onCompute={() => setCurrent("DSOutput")} />;
                            break;
                        case "DSOutput":
                            component = <DSOutput data={scanAlgo(diskSchedData)}/>
                            break;
                    }
                    return (
